...
<%@page import="com.shop.Setting"%>
<%@page import="com.shop.util.SettingUtils"%>
<%@page import="com.shop.util.SpringUtils"%>
<%@page import="com.shop.Setting.CaptchaType"%>
<%@page import="com.shop.Setting.AccountLockType"%>
<%@page import="com.shop.service.RSAService"%>
	...
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.gif"/>
						</td>
						<th>
				...
				<div class="powered">COPYRIGHT © 2013-2014  中国地毯网 版权所有</div>
			</form>
		</div>
	<%} else {%>
		<fieldset>
