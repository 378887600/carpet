...
$().ready(function() {
	...
	// 会员价
	function changeMemberRanks(obj){
		var $memberLabel=$(obj).parent().find("label");
		var $memberPrice=$memberLabel.find("input");
		if ($(obj).prop("checked")) {
			$memberLabel.show();
		...
		<table class="input tabContent">
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="${message("admin.common.addType")}" onclick="addProductType(this)"/>
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="unit" class="text" maxlength="200" value="${message("admin.common.piece")}"/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<table id="specificationProductTable" class="input">
						<tr class="title">
							...
							[/#list]
							<td>
								${message("admin.common.salePrice")}
							</td>
							<td>
								${message("Product.cost")}
							</td>
							<td>
								${message("admin.common.stock")}
							</td>
							<td>
								${message("admin.product.isMemberPrice")}
							</td>
							<td>
						...
						<tr class="hidden">
							...
							[/#list]
							<td>
								<input type="text" name="price1" class="text" maxlength="8" style="width: 60px;"/>
							</td>
							<td>
								<input type="text" name="cost" class="text" maxlength="8" style="width: 60px;"/>
							</td>
							<td>
								<input type="text" name="price11" class="text" maxlength="8" style="width: 50px;"/>
							</td>
							<td>
								<input type="checkbox" checked name="isMemberPrice" onclick="changeMemberRanks(this);"/>
								<label>
								[#assign replaceMember='${message("admin.common.member")}'/]
								[#list memberRanks as memberRank]
								${memberRank.name?replace(replaceMember,"")}: <input type="text" name="memberPrice_${memberRank.id}" class="text memberPrice" maxlength="8" style="width: 60px; margin-right: 6px;"/>
								[/#list]
							   </label>
							</td>
							<td>
