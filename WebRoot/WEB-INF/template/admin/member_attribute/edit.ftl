...
<title>${message("admin.memberAttribute.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.memberAttribute.edit")}
	</div>
