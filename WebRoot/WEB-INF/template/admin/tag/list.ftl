...
<title>${message("admin.tag.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.tag.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
