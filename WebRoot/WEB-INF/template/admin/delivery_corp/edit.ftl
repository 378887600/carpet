...
<title>${message("admin.deliveryCorp.edit")}</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="code" name="code" class="text" maxlength="200" value="${deliveryCorp.code}" title="${message("admin.deliveryCorp.codeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
