...
[@seo type = "productContent"]
	<title>[#if product.seoTitle??]${product.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if systemShowPowered][/#if]</title>
			...
			<div class="info">
				...
				<dl>
				    ...
				    <dd>
						...
						[#if product.scoreCount > 0]
							<div class="score">
								<strong style="display:block; float:left;">${product.score?string("0.0")}</strong>
								<div class="scorefloat">
									<div class="score${(product.score * 2)?string("0")} scorefloat"></div>
									<div class="scorefloat">${message("Product.scoreCount")}: ${product.scoreCount}</div>
								</div>
							</div>
						[#else]
							<div class="score">
								<strong style="display:block; float:left;">5</strong>
								<div class="scorefloat">
									<div class="score10 scorefloat"></div>
									<div class="scorefloat">${message("Product.scoreCount")}: ${product.scoreCount}</div>
								</div>
							</div>
						[/#if]
