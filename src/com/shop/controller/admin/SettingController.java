...
import com.shop.CommonAttributes;
import com.shop.FileInfo.FileType;
import com.shop.Message;
import com.shop.Setting;
import com.shop.Setting.AccountLockType;
import com.shop.Setting.CaptchaType;
import com.shop.Setting.ConsultationAuthority;
import com.shop.Setting.ReviewAuthority;
import com.shop.Setting.RoundType;
import com.shop.Setting.StockAllocationTime;
import com.shop.Setting.WatermarkPosition;
...
public class SettingController extends BaseController {
	...
	public String update(Setting setting, MultipartFile watermarkImageFile, RedirectAttributes redirectAttributes) {
		...
		try {
			org.springframework.core.io.Resource resource = new ClassPathResource(CommonAttributes.SHOP_PROPERTIES_PATH);
			...
			if (setting.getIsDevelopmentEnabled()) {
				if (!templateUpdateDelay.equals("0") || !messageCacheSeconds.equals("0")) {
					...
					properties.store(outputStream, "CARPET PROPERTIES");
				}
			} else {
				if (templateUpdateDelay.equals("0") || messageCacheSeconds.equals("0")) {
					outputStream = new FileOutputStream(resource.getFile());
